...
2. Secret-driven: when ``SLUICE_FORBIDDEN_IDENTIFIERS`` is set (a
...
def _resolve_identifiers() -> frozenset[str] | None:
    ...
    if not raw.strip():
        ...
        print(
            "SLUICE_FORBIDDEN_IDENTIFIERS is empty or unset; "
    ...
    if not identifiers:
        print(
            "SLUICE_FORBIDDEN_IDENTIFIERS contained no usable "
